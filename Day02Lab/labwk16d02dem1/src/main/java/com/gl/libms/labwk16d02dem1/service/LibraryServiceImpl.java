package com.gl.libms.labwk16d02dem1.service;
...
import com.gl.libms.labwk16d02dem1.dao.LibraryRepository;
import com.gl.libms.labwk16d02dem1.model.Library;
 ...
 */
	public List<Library> getAllLibrariesWithNoBooks() {
		...
		//libraryWithNoBooks.setCommaSeperatedBooknames("Night");
	...
	public List <Library> getLibrariesPaged(int fromRecord,int noOfRecords) {
		...
		List <Library> libraries =  libRepository.findAll(Sort.by(Direction.DESC, "name"));
		
		//libraries.sort(new Library());
		
		
		return libRepository.findAll(first3records).get().collect(Collectors.toList());
		
		//PageRequest.of
		//PageRequest.of(fromRecord, noOfRecords)
		// PageRequest.of(fromRecord, noOfRecords, null)
		//PageRequest.of(fromRecord, noOfRecords, null, null)
		//PageRequest.ofSize(noOfRecords)
	}
